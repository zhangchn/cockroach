...
func MVCCGet(engine Engine, key proto.Key, timestamp proto.Timestamp, consistent bool, txn *proto.Transaction) (*proto.Value, error) {
	...
	return mvccGetInternal(engine, key, proto.RawKeyValue{Key: metaKey, Value: data}, timestamp, consistent, txn, earlier)
}
...
func mvccGetInternal(engine Engine, key proto.Key, kv proto.RawKeyValue, timestamp proto.Timestamp,
	consistent bool, txn *proto.Transaction, earlier getEarlierFunc) (*proto.Value, error) {
...
func MVCCIterate(engine Engine, key, endKey proto.Key, timestamp proto.Timestamp,
	...
	for {
		...
		if isValue {
			return util.Errorf("expected an MVCC metadata key: %q", kv.Key)
		}
		value, err := mvccGetInternal(engine, key, kv, timestamp, consistent, txn, earlier)
		if err != nil {
			return err
		}
		if value != nil {
